...
const Footer = () => {
    return (
        <div className='shadow-lg shadow-slate-600 mt-10'>
       <footer className="footer p-10 bg-transparent text-slate-600  shadow-slate-400">
  <div>
...
<footer className="footer px-10 py-4  bg-transparent text-base-content border-base-300">
  <div className="items-center grid-flow-col text-slate-600">
    ...
    <p>Copyright 2022 | Redefine Status.</p>
  </div> 
