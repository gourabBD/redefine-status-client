...
const SecondSection = () => {
    return (
        <div data-aos="fade-down-left" className="mt-10 shadow-md shadow-slate-400 p-5">
      ...
      On a fundamental level once someone gets the basics covered as in food, water, shelter. They can start to spend their time and money on convenience, health, and purpose but more often than not; status is where a majority of surplus wealth goes. <br />
 <br />
 ...
 What we wear is the most direct way we have to represent ourselves and our ideals/values. What your role model wears, or any person of influence is shaping the idea of status in that child, teenager, or adults mind. <br />
  <br />
  <span className='font-bold'> Status is what we are buying when we pay $1, $10, or even $500 extra for a certain brand of T-Shirt irrespective of comfort.</span>
 <br />
  <br />
 ...
 If we can provide a better representation of status in clothing we can not only change the money used to buy status into doing good for the world, but we can change our core representation of status in society towards doing good. <br />
  <br />
 While the larger belief is that this systemic change is the real impact in realigning our culture towards true status, the amount of funds in status spending that could be redirected towards positive causes is also no joke. <br />
      </p>

      <p className="mt-10 text-xl border-l-4 border-primary font-medium text-slate-600 text-left pl-5 font-sans hover:font-serif">
      The personal luxury goods market is projected to grow  from USD <a className="underline link-primary" href="https://www.fortunebusinessinsights.com/luxury-goods-market-103866">257.26 billion in 2020 to USD 352.84 billion in 2027</a> 
      </p>


      <p className="mt-10 text-xl border-l-4 border-primary font-medium text-slate-600 text-left pl-5 font-sans hover:font-serif">
      The Luxury Cars Market size is expected to grow from <a  className="underline link-primary" href="https://www.globenewswire.com/en/news-release/2022/09/19/2518123/0/en/Luxury-Cars-Market-Size-Worth-USD-655-0-Billion-Globally-by-2027-at-9-3-CAGR.html#:~:text=The%20Luxury%20Cars%20Market%20size,9.3%25%20from%202020%20to%202027.&text=Pune%2C%20India%2C%20Sept.,by%20the%20end%20of%202027.">USD 449.7 Billion in 2019 to USD 655.0 Billion by 2027; It is estimated to grow at a CAGR of 9.3% from 2020 to 2027. </a> 
      </p>
    </div>
    );
};
